...
public class SoulsAndSorcery implements ModInitializer {
	...
	public static final EntityAttribute GENERIC_SOUL_GATHERING = new ClampedEntityAttribute("attribute.name.generic.soul_gathering", 0.0D, 0.0D, 5.0D).setTracked(true);
