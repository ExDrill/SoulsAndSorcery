...
public class ModItems {
    ...
    public static final GlaringEyeItem GLARING_EYE = new GlaringEyeItem(1, new Item.Settings().group(ItemGroup.COMBAT).maxCount(1).maxDamage(128).rarity(Rarity.RARE));
